...
domain=ftw.referencewidget
maindir=ftw/referencewidget
...
./venv/bin/i18ndude rebuild-pot --pot $locales/$domain.pot --create $domain $maindir --exclude="node_modules"
./venv/bin/i18ndude sync --pot $locales/$domain.pot $locales/*/LC_MESSAGES/$domain.po
