...
class TestJsonViewSearch(TestCase):
    layer = FTW_REFERENCE_FUNCTIONAL_TESTING
    ...
    def test_search_view(self):
        ...
        view = ReferenceJsonEndpoint(self.widget, self.widget.request)
        result = view()
...
class TestJsonViewSearchWithPathRestriction(FunctionalTestCase):

    def setUp(self):
        super(TestJsonViewSearchWithPathRestriction, self).setUp()
    ...
    def _get_search_result_from_widget(self, source, name):
        ...
        return json.loads(ReferenceJsonEndpoint(widget, widget.request)())
